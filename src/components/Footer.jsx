...
function Footer() {
  return (
    <div className="container text-white px-4 pt-16 mx-auto px-4 md:px-12">
        <div className="bg-[#2e3039] dark:bg-gray-100 py-8 px-4 md:px-8 rounded-xl grid gap-10 md:grid-cols-3 md:py-4">
            ...
            <div className="md:py-8">
                ...
                <div className="flex gap-2 items-center">
                    <span className="dark:text-black"> <HiOutlineMail size={24} /> </span>
                    <p className="text-gray-400 dark:text-black">ayesorofemi@gmail.com</p>
                </div>
               <div className="flex gap-2 mt-4 items-center">
                <span  className="dark:text-black"><MdPhoneIphone size={24} /></span>
